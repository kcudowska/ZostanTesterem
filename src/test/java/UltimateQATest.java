...
public class UltimateQATest extends PageSetup {
   ...
   //zwracanie z funkcji: jakiś typ, void - nic nie zwraca
    ...
    //dopisać przypadki testowe na button using ClassName i Name

    @Test
    public void testTwo() throws InterruptedException {
        //sposoby na wyszukiwanie elementów w Selenium: xpath, className, id, selektory, CSS
        ...
        Thread.sleep(2000);
        //ogólna postać xpath:  //*(div, p, itp.)[]
        //odbijanie się od elementu: //*(@class='')/p  / - jeden poziom, // - 1 poziom i więcej
    ...
    public void testThree() {
        ...
        //różnica pomiędzy List a ArrayList
        ...
        // xpath wyszukiwanie po tekście: //*text()=''
